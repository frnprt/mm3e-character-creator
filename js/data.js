...
const ADVANTAGES = [
  ...
  { id: 'agileFeint', name: 'Agile Feint', ranked: false, cost: 1, category: 'Combat', description: 'Feint using Acrobatics instead of Deception' },
  ...
  { id: 'assessment', name: 'Assessment', ranked: false, cost: 1, category: 'General', description: 'Assess opponent with Insight' },
  { id: 'attractive', name: 'Attractive', ranked: true, cost: 1, category: 'General', maxRanks: 2, description: 'Circumstance bonus on interaction checks' },
  ...
  { id: 'daze', name: 'Daze', ranked: true, cost: 1, category: 'General', hasSpecialty: true, maxRanks: 2, description: 'Daze with Deception or Intimidation' },
  { id: 'diehard', name: 'Diehard', ranked: false, cost: 1, category: 'General', description: 'Auto-stabilize when dying' },
  { id: 'eidetic', name: 'Eidetic Memory', ranked: false, cost: 1, category: 'General', description: 'Perfect recall' },
  ...
  { id: 'fascinate', name: 'Fascinate', ranked: true, cost: 1, category: 'General', hasSpecialty: true, description: 'Entrance with a skill check' },
  ...
  { id: 'hideInPlainSight', name: 'Hide in Plain Sight', ranked: false, cost: 1, category: 'General', description: 'Hide without cover' },
  ...
  { id: 'jackOfAllTrades', name: 'Jack-of-all-trades', ranked: false, cost: 1, category: 'General', description: 'Use untrained skills' },
  ...
  { id: 'skillMastery', name: 'Skill Mastery', ranked: true, cost: 1, category: 'General', hasSpecialty: true, description: 'Routine checks with one skill' },
  { id: 'startle', name: 'Startle', ranked: false, cost: 1, category: 'General', description: 'Feint with Intimidation' },
  { id: 'taunt', name: 'Taunt', ranked: false, cost: 1, category: 'General', description: 'Demoralize with Deception' },
  { id: 'teamwork', name: 'Teamwork', ranked: false, cost: 1, category: 'General', description: '+5 team check bonus' },
  { id: 'tracking', name: 'Tracking', ranked: false, cost: 1, category: 'General', description: 'Track by Perception' },
  { id: 'trance', name: 'Trance', ranked: false, cost: 1, category: 'General', description: 'Self-induced trance' },
  { id: 'wellInformed', name: 'Well-informed', ranked: false, cost: 1, category: 'General', description: 'Immediate knowledge check' },
];

const ADVANTAGE_CATEGORIES = ['Combat', 'Fortune', 'General'];
...
const POWER_EFFECTS = [
  ...
  // General Effects
  { id: 'enhancedTrait', name: 'Enhanced Trait', type: 'General', costPerRank: 1, action: 'Free', range: 'Personal', duration: 'Sustained', resistance: '-', variableCost: [{cost: 2, label: 'Ability (2/rank)'}, {cost: 1, label: 'Defense / Skill / Advantage (1/rank)'}], description: 'Enhance a trait (ability, skill, advantage, defense)' },
...
const POWER_EXTRAS = [
  ...
  { id: 'impervious', name: 'Impervious', costType: 'perRank', costValue: 1, appliesTo: ['protection'], description: 'Ignore effects with rank \u2264 half your rank (for defense effects)' },
...
const CONDITIONS = [
  ...
  { name: 'Deaf', description: 'Cannot hear. -5 Perception. –5 initiative.' },
  ...
  { name: 'Prone', description: 'Hindered. –5 to close attacks against you. +5 to ranged attacks against you.' },
  { name: 'Restrained', description: 'Hindered and Vulnerable. –2 to attack checks and Dodge.' },
...
const EQUIPMENT_LIST = [
  ...
  // Armor — Modern
  { name: 'Undercover Shirt', cost: 2, type: 'Armor', details: 'Protection 2, Limited to Ballistic, Subtle', bonuses: { toughness: 2 } },
  { name: 'Bulletproof Vest', cost: 3, type: 'Armor', details: 'Protection 4, Limited to Ballistic, Subtle', bonuses: { toughness: 4 } },
  // Shields
